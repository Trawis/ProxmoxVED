...
// Proxy mode: omitting "user" turns the server into a multi-account gateway.
// Each client authenticates with its own Filen email and
// "password=<password>&twoFactorAuthentication=<code>" (2FA part optional).
